                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-6">
                            <div class="input-group  {{($errors->has('email')?'has-error':'')}}">
                                ...
                                <input required="required" value="{{old('email')}}" type="text" class="form-control" name="email" placeholder="user@somedomain.com">
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="input-group {{($errors->has('first_name')?'has-error':'')}}">
                                ...
                                <input required="required"  value="{{old('first_name')}}"  type="text" class="form-control" id="first_name" name="first_name" placeholder="John">
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="input-group {{($errors->has('last_name')?'has-error':'')}}">
                                <span class="input-group-addon"> <i class="fa fa-user"></i></span>
                                <input required="required" type="text"  value="{{old('last_name')}}"  class="form-control" id="last_name" name="last_name" placeholder="Doe">
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="input-group {{($errors->has('password')?'has-error':'')}}">
                                ...
                                <input required="required" type="password"  value="{{old('password')}}"  class="form-control" id="password" name="password" placeholder="Password">
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="input-group {{($errors->has('confirm_password')?'has-error':'')}}">
                                <span class="input-group-addon"> <i class="fa fa-key"></i></span>
                                <input required="required" type="password"  value="{{old('confirm_password')}}"  class="form-control" id="confirm_password" name="confirm_password" placeholder="Confirm Password">
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="input-group {{($errors->has('name')?'has-error':'')}}">
                                ...
                                <input type="text" required value="{{old('name')}}" placeholder="Username" id="name" class="form-control" name="name">
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="input-group {{($errors->has('roles')?'has-error':'')}}">
                                ...
                                {!! Form::select('roles', get_roles(),count(get_roles()) ,['class'=>'form-control']) !!}
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="input-group {{($errors->has('address')?'has-error':'')}}">
                                ...
                                <textarea required="required" class="form-control" id="address" name="address" placeholder="Larkin Fork, 282 Kevin Brook, Apt. 672">{{old('address')}}</textarea>
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="input-group {{($errors->has('city')?'has-error':'')}}">
                                ...
                                <input required="required" type="text"  value="{{old('city')}}"  class="form-control" id="city" name="city" placeholder="Kochi">
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="input-group {{($errors->has('state')?'has-error':'')}}">
                                <span class="input-group-addon"> <i class="fa fa-map-marker"></i></span>
                                <input required="required" type="text"  value="{{old('state')}}"  class="form-control" id="state" name="state" placeholder="Kerala">
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="input-group {{($errors->has('postcode')?'has-error':'')}}">
                                ...
                                <input required="required" type="text"  value="{{old('postcode')}}"  class="form-control" id="postcode" name="postcode" placeholder="682020">
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="input-group {{($errors->has('phone')?'has-error':'')}}">
                                ...
                                <input required="required" type="text"  value="{{old('phone')}}"  class="form-control" id="phone" name="phone" placeholder="(999) 536-2824">
                            </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <button type="submit" class="btn btn-success pull-right"><i class="fa fa-save"></i>  Add User</button>
